 ...
 * 
 */
@WebServiceClient(name = "WeatherWS", targetNamespace = "http://WebXml.com.cn/", wsdlLocation = "file:/E:/Java/workspace_wyh_web/brd_jms/src/com/brd/business/weather/weather.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/E:/Java/workspace_wyh_web/brd_jms/src/com/brd/business/weather/weather.wsdl");
