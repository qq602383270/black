 ...
 * generated in the com.brd.business.weather.java package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.brd.business.weather.java
     * 
     */
